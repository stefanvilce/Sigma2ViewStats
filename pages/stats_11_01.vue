...
export default {
    ...
    head: {
        title: 'NIRD - ViewStatistics, Total size EXTENT / Year Cumulative',
        meta: [
        { charset: 'utf-8' },
        { name: 'viewport', content: 'width=device-width, initial-scale=1' },
        {
            hid: 'description',
            name: 'description',
            content: 'NIRD - ViewStatistics, Total size EXTENT / Year, Cumulative'
        }
        ],
    ...
    methods: {
        ...
        generateBars() {
            ...
            // SUMARIZE (an example of How to do it):
