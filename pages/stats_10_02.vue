...
export default {
    ...
    head: {
        title: 'NIRD - ViewStatistics, No. of Datasets / Month, cumulative',
        meta: [
        { charset: 'utf-8' },
        { name: 'viewport', content: 'width=device-width, initial-scale=1' },
        {
            hid: 'description',
            name: 'description',
            content: 'NIRD - ViewStatistics, No. of Datasets / Month, cumulative'
        }
        ],
        ...
        generateBars() {
            ...
            d3.select('#saveButton').on('click', function(){
                ...
                function save( dataBlob, filesize ){
                    saveAs( dataBlob, '10.02.DatasetsPerMonthCumulative.png' ); // FileSaver.js function
                }
            });
            ...
            .attr("fill", "#FFB500")
            .text("Total Datasets (cumulative) / Month");
            ...
            var nested_data = d3.rollups(data, v => v.length, d => d.datepublished.substring(0, 7)).map(([k, v]) => ({ DateP: k, Sumextent: v }));
            var dateNew = [];            
